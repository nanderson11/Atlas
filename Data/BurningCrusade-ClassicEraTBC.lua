...
db.AtlasMaps = {
	CL_AuchindounEnt = {
		...
		{ GREY..INDENT..L["Greatfather Aldrimus"] },
		{ GREY..INDENT..L["Ha'lei"] },
		{ GREY..INDENT..L["Horvon the Armorer <Armorsmith>"] },
		{ GREY..INDENT..L["Ramdor the Mad"] },
		{ GREY.." 2) "..L["Nexus-Prince Haramad"],           10007 },
		{ GREY..INDENT..L["Artificer Morphalius"] },
		{ GREY..INDENT..L["Mamdy the \"Ologist\""] },
		{ GREY..INDENT..L["\"Slim\" <Shady Dealer>"] },
		{ GREY..INDENT..L["\"Captain\" Kaftiz"] },
		{ GREY.." 3) "..L["Isfar"],                          10008 },
		{ GREY.." 4) "..L["Field Commander Mahfuun"],        10009 },
		{ GREY..INDENT..L["Spy Grik'tha"] },
		{ GREY..INDENT..L["Dealer Tariq <Shady Dealer>"] },
		{ GREY..INDENT..L["Provisioner Tsaalt"] },
		{ GREY.." 5) "..ALC["Meeting Stone"],                10010 },
	},
	...
	CL_AuchManaTombs = {
		...
		{ GREY.." 3) "..L["Ethereal Transporter Control Panel"] },
		{ WHIT.." 4) "..Atlas_GetBossName("Nexus-Prince Shaffar", 537),                                                                                                537 },
		{ ORNG..INDENT..Atlas_GetBossName("Yor <Void Hound of Shaffar>", 536)..ALC["L-Parenthesis"]..ALC["Summon"]..ALC["Comma"]..ALC["Heroic"]..ALC["R-Parenthesis"], 536 },
	},
	CL_AuchSethekkHalls = {
	...
	CL_AuchShadowLabyrinth = {
		...
		{ GREY..INDENT..L["The Codex of Blood"] },
		{ WHIT.." 5) "..Atlas_GetBossName("Murmur", 547),                 547 },
		{ GREY.." 6) "..ALC["Arcane Container"],                          10002 },
		{ GREY..INDENT..L["First Fragment Guardian"] },
	},
	CL_BlackTempleStart = {
	...
	CL_CFRTheSlavePens = {
		...
		{ GREY.." 2) "..L["Weeder Greenthumb"],                                                                10002 },
		{ WHIT.." 3) "..L["Skar'this the Heretic"]..ALC["L-Parenthesis"]..ALC["Heroic"]..ALC["R-Parenthesis"], 10003 },
		{ WHIT.." 4) "..Atlas_GetBossName("Rokmar the Crackler", 571),                                         571 },
		{ GREY.." 5) "..L["Naturalist Bite"],                                                                  10004 },
	...
	CL_CFRTheSteamvault = {
		...
		{ GREY..INDENT..L["Main Chambers Access Panel"] },
		{ GREY.." 2) "..L["Second Fragment Guardian"],                   10002 },
		{ GREY..INDENT..ALC["Arcane Container"] },
		{ WHIT.." 3) "..Atlas_GetBossName("Mekgineer Steamrigger", 574), 574 },
		{ GREY..INDENT..L["Main Chambers Access Panel"] },
		{ WHIT.." 4) "..Atlas_GetBossName("Warlord Kalithresh", 575),    575 },
	},
	CL_CFRTheUnderbog = {
		...
		{ GREY..INDENT..L["The Underspore"] },
		{ WHIT.." 2) "..Atlas_GetBossName("Ghaz'an", 577),            577 },
		{ GREY.." 3) "..L["Earthbinder Rayge"],                       10002 },
	...
	CL_HCHellfireRamparts = {
		...
		{ ORNG..REPUTATION..ALC["Colon"]..BF["Thrallmar"]..ALC["L-Parenthesis"]..FACTION_HORDE..ALC["R-Parenthesis"] },
		{ BLUE.." A) "..ALC["Entrance"],                                                                                 10001 },
		{ GREY..INDENT..L["Advance Scout Chadwick"]..ALC["L-Parenthesis"]..FACTION_ALLIANCE..ALC["R-Parenthesis"] },
		{ GREY..INDENT..L["Stone Guard Stok'ton"]..ALC["L-Parenthesis"]..FACTION_HORDE..ALC["R-Parenthesis"] },
		...
		{ GREY..INDENT..L["Reinforced Fel Iron Chest"] },
	},
	...
	CL_TempestKeepMechanar = {
		...
		{ ORNG..REPUTATION..ALC["Colon"]..BF["The Sha'tar"] },
		{ BLUE.." A) "..ALC["Entrance"],                                                                                              10001 },
		{ WHIT.." 1) "..Atlas_GetBossName("Gatewatcher Gyro-Kill"),                                                                   10002 },
		{ WHIT.." 2) "..Atlas_GetBossName("Gatewatcher Iron-Hand"),                                                                   10003 },
		{ GREY..INDENT..Atlas_GetBossName("Cache of the Legion"),                                                                     10004 },
		{ WHIT.." 3) "..Atlas_GetBossName("Mechano-Lord Capacitus", 563)..ALC["L-Parenthesis"]..ALC["Wanders"]..ALC["R-Parenthesis"], 563 },
		{ GREY..INDENT..L["Overcharged Manacell"] },
	...
	CoTHyjal = {
		...
		{ GREY..INDENT..L["Lady Jaina Proudmoore"] },
		{ BLUE.." B) "..BZ["Horde Encampment"],                              10002 },
		{ GREY..INDENT..L["Thrall <Warchief>"] },
		{ BLUE.." C) "..BZ["Night Elf Village"],                             10003 },
		{ GREY..INDENT..L["Tyrande Whisperwind <High Priestess of Elune>"] },
...
db.AtlasMaps_NPC_DB = {
	...
	CFRTheSlavePens = {
		...
		{ 4,    571,   288, 220 }, -- Rokmar the Crackler
		{ 6,    572,   401, 369 }, -- Quagmirran
		{ "A",  10001, 116, 103 },
		{ 2,    10002, 245, 345 }, -- Weeder Greenthumb
		{ 3,    10003, 292, 366 }, -- Skar'this the Heretic
		{ 5,    10004, 488, 309 }, -- Naturalist Bite
	},
	CFRTheSteamvault = {
	...
	TempestKeepMechanar = {
		{ 1,    10002, 227, 281 }, -- Gatewatcher Gyro-Kill
		{ 2,    10003, 331, 256 }, -- Gatewatcher Iron-Hand
